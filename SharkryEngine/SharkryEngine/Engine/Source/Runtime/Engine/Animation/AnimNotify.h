...
struct FAnimNotifyEvent 
{
    ...
    FAnimNotifyEvent()
        :TriggerTime(0.0f), TriggerFrame(0), Duration(0.0f),
        TriggerEndFrame(0), isTriggerEndClicked(false),
        NotifyName(""), NotifyMode(ENotifyMode::Single), NotifyState(ENotifyState::None),
        TrackNum(1)
    { }
